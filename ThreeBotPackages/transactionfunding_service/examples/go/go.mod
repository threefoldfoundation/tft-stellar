module github.com/threefoldfoundation/tft-stellar/ThreeBotPackages/transactionfunding_service/examples/go

go 1.20

require (
	github.com/alecthomas/kong v0.7.1
	github.com/stellar/go v0.0.0-20230616010256-01c7aa30745a
)
