...
def activate_account(address, source_keypair, starting_balance=2):
    ...
    tx = (
        stellar_sdk.transaction_builder.TransactionBuilder(source_account)
        .append_create_account_op(address, starting_balance=decimal.Decimal(value=starting_balance))
        .build()
    )
